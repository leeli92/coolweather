...
def generator(x, reuse=False, scope='generator'):
    ...
    with tf.variable_scope(scope, reuse=reuse):
        with slim.arg_scope([slim.conv2d, slim.conv2d_transpose],
            ...
            deconv1_2 = tf.layers.conv2d_transpose(conv3_2,16,[3,3],padding="same",strides=(2,2))
            ...
            deconv2_2 = tf.layers.conv2d_transpose(deconv1_2, 16, [3, 3], padding="same", strides=(2,2))
